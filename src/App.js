  ...
  return (
    <div className="App">
      <header className="header bg-primary text-white py-5 text-center">
        <h1 className="name">E Satwika</h1>
      ...
      <section className="contact py-5 bg-primary text-white">
        <div className="container">
          ...
          <p>LinkedIn: <a href="https://www.linkedin.com/in/satwika_chowdary-8a5ba61b4/" target="_blank" rel="noopener noreferrer">LinkedIn Profile</a></p>
